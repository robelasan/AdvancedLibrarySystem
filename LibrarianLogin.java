...
public class LibrarianLogin extends JFrame{
	...
	private String username [] = {"Librarian01", "Librarian02", "Librarian03"};
	...
	public LibrarianLogin() {
		...
		librarianLbl.setBackground(new Color(128, 128, 128));
		librarianLbl.setForeground(new Color(0, 0, 0));
		librarianLbl.setHorizontalAlignment(SwingConstants.CENTER);
		librarianLbl.setFont(new Font("Arial", Font.BOLD, 20));
		librarianLbl.setBounds(215, 50, 180, 50);
		contentPane.add(librarianLbl);
